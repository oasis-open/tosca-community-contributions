...
| I22 | **Profile organization / naming** — should the technology profiles live under `community/tosca` or use reverse-DNS (e.g. `io.kubernetes`)? Clarify team-designed profiles vs. broader community contributions. | 🔴 | Chris | Start a GitHub discussion to gather opinions (from 2026-07-15). |

## VnfCreateSnapshotOperationConfiguration Data
...
|:---- |:--- |:------- |:------------ |
| `VnfCreateSnapshotOperationConfiguration` | `tosca.datatypes.nfv.VnfCreateSnapshotOperationConfiguration` | `4.4.1` | `tosca.datatypes.Root` |

## VnfChangeFlavourOperationConfiguration Data
...
|:---- |:--- |:------- |:------------ |
| `VnfChangeFlavourOperationConfiguration` | `tosca.datatypes.nfv.VnfChangeFlavourOperationConfiguration` | `4.4.1` | `tosca.datatypes.Root` |

## VirtualNetworkInterfaceRequirements Data
...
|:---- |:--- |:------- |:------------ |
| `VirtualNetworkInterfaceRequirements` | `tosca.datatypes.nfv.VirtualNetworkInterfaceRequirements` | `4.4.1` | `tosca.datatypes.Root` |

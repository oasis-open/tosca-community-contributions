## VnfRevertToSnapshotOperationConfiguration Data
...
|:---- |:--- |:------- |:------------ |
| `VnfRevertToSnapshotOperationConfiguration` | `tosca.datatypes.nfv.VnfRevertToSnapshotOperationConfiguration` | `4.4.1` | `tosca.datatypes.Root` |

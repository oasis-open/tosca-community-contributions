## VnfChangeCurrentPackageOperationConfiguration Data
...
|:---- |:--- |:------- |:------------ |
| `VnfChangeCurrentPackageOperationConfiguration` | `tosca.datatypes.nfv.VnfChangeCurrentPackageOperationConfiguration` | `4.4.1` | `tosca.datatypes.Root` |

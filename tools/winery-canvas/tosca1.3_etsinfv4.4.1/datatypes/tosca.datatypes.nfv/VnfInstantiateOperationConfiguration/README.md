## VnfInstantiateOperationConfiguration Data
...
|:---- |:--- |:------- |:------------ |
| `VnfInstantiateOperationConfiguration` | `tosca.datatypes.nfv.VnfInstantiateOperationConfiguration` | `4.4.1` | `tosca.datatypes.Root` |

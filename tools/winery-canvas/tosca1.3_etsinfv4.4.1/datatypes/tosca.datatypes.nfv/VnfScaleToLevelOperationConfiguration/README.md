## VnfScaleToLevelOperationConfiguration Data
...
|:---- |:--- |:------- |:------------ |
| `VnfScaleToLevelOperationConfiguration` | `tosca.datatypes.nfv.VnfScaleToLevelOperationConfiguration` | `4.4.1` | `tosca.datatypes.Root` |

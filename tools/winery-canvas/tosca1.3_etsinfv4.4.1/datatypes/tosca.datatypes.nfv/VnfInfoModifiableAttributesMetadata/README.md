## VnfInfoModifiableAttributesMetadata Data
...
|:---- |:--- |:------- |:------------ |
| `VnfInfoModifiableAttributesMetadata` | `tosca.datatypes.nfv.VnfInfoModifiableAttributesMetadata` | `4.4.1` | `tosca.datatypes.Root` |

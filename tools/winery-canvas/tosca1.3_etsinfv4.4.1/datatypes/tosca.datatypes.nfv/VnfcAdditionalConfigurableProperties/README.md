## VnfcAdditionalConfigurableProperties Data
...
|:---- |:--- |:------- |:------------ |
| `VnfcAdditionalConfigurableProperties` | `tosca.datatypes.nfv.VnfcAdditionalConfigurableProperties` | `4.4.1` | `tosca.datatypes.Root` |

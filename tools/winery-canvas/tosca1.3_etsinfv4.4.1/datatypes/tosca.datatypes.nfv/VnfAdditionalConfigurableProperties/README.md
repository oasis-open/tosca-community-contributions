## VnfAdditionalConfigurableProperties Data
...
|:---- |:--- |:------- |:------------ |
| `VnfAdditionalConfigurableProperties` | `tosca.datatypes.nfv.VnfAdditionalConfigurableProperties` | `4.4.1` | `tosca.datatypes.Root` |

## VnfInfoModifiableAttributesExtensions Data
...
|:---- |:--- |:------- |:------------ |
| `VnfInfoModifiableAttributesExtensions` | `tosca.datatypes.nfv.VnfInfoModifiableAttributesExtensions` | `4.4.1` | `tosca.datatypes.Root` |

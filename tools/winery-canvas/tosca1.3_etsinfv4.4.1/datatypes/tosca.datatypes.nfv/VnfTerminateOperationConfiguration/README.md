## VnfTerminateOperationConfiguration Data
...
|:---- |:--- |:------- |:------------ |
| `VnfTerminateOperationConfiguration` | `tosca.datatypes.nfv.VnfTerminateOperationConfiguration` | `4.4.1` | `tosca.datatypes.Root` |

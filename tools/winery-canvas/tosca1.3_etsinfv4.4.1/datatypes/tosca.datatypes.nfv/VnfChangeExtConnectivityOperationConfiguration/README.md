## VnfChangeExtConnectivityOperationConfiguration Data
...
|:---- |:--- |:------- |:------------ |
| `VnfChangeExtConnectivityOperationConfiguration` | `tosca.datatypes.nfv.VnfChangeExtConnectivityOperationConfiguration` | `4.4.1` | `tosca.datatypes.Root` |

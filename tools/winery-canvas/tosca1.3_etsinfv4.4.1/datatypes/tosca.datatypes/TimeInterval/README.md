...
### Description
The TimeInterval type describes a period of time using the YAML ISO 8601 format to declare the start and end times.

| Name | URI | Version | Derived From |
|:---- |:--- |:------- |:------------ |
| `TimeInterval` | `tosca.datatypes.TimeInterval` | `1.3.0` | `tosca.datatypes.Root` |

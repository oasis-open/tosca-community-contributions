...
### Description
The Network capability, when included on a Node Type or Template definition, indicates that the node can provide addressiblity for the resource on a named network with the specified ports.

| Name | URI | Version | Derived From |
|:---- |:--- |:------- |:------------ |
| `Network` | `tosca.capabilities.Network` | `1.3.0` | `tosca.capabilities.Root` |

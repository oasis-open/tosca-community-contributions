## VirtualLinkToInstantiationLevelMapping Policy
...
|:---- |:--- |:------- |:------------ |
| `VirtualLinkToInstantiationLevelMapping` | `tosca.policies.nfv.VirtualLinkToInstantiationLevelMapping` | `4.4.1` | `tosca.policies.Root` |

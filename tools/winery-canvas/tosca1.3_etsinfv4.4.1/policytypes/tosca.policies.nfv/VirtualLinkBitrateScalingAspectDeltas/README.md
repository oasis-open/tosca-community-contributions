## VirtualLinkBitrateScalingAspectDeltas Policy
...
|:---- |:--- |:------- |:------------ |
| `VirtualLinkBitrateScalingAspectDeltas` | `tosca.policies.nfv.VirtualLinkBitrateScalingAspectDeltas` | `4.4.1` | `tosca.policies.Root` |

# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/node-templates/node-templates-empty-inv_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/node-templates-empty-inv.yaml'

# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/namespaces/namespaces-duplicate-repo-root-inv_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/namespaces-duplicate-repo-root-inv.yaml'

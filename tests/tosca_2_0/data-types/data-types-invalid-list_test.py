# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/data-types/data-types-invalid-list_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/data-types-invalid-list.yaml'

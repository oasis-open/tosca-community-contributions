# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/import-definitions/imports-11-invalid-empty_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/imports-11-invalid-empty.yaml'

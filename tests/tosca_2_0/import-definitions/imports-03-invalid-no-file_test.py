# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/import-definitions/imports-03-invalid-no-file_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/imports-03-invalid-no-file.yaml'

# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/output-parameters/output-parameters-empty-inv_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/output-parameters-empty-inv.yaml'

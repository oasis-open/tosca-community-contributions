# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/profiles/profile-invalid-service_template_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/profile-invalid-service_template.yaml'

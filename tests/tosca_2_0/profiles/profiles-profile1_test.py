# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/profiles/profiles-profile1_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/profiles-profile1.yaml'

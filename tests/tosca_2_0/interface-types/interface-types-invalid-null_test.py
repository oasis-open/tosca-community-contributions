# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/interface-types/interface-types-invalid-null_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/interface-types-invalid-null.yaml'

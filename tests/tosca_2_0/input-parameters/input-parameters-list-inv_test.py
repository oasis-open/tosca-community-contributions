# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/input-parameters/input-parameters-list-inv_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/input-parameters-list-inv.yaml'

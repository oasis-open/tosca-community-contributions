# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/tutorial/source-and-target_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/source-and-target.yaml'

# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/tutorial/imports/super-load-balancer_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/super-load-balancer.yaml'

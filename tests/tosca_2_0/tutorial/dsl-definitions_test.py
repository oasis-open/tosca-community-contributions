# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/tutorial/dsl-definitions_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/dsl-definitions.yaml'

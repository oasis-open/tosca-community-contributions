# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/tutorial/requirements-and-capabilities_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/requirements-and-capabilities.yaml'

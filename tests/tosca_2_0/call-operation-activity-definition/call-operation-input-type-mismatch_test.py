# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/call-operation-activity-definition/call-operation-input-type-mismatch_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/call-operation-input-type-mismatch.yaml'

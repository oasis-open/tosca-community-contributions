# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/function-definitions/functions-invalid-null_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/functions-invalid-null.yaml'

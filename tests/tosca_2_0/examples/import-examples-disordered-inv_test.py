# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/examples/import-examples-disordered-inv_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/import-examples-disordered-inv.yaml'

# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/repository-definitions/repositories-03-invalid-no-url_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/repositories-03-invalid-no-url.yaml'

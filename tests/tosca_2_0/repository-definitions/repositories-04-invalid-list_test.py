# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/repository-definitions/repositories-04-invalid-list_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/repositories-04-invalid-list.yaml'

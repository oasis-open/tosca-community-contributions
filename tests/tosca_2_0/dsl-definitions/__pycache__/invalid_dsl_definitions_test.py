# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/dsl-definitions/__pycache__/invalid_dsl_definitions_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/invalid_dsl_definitions.yaml'

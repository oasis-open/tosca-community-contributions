# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/dsl-definitions/dsl_definitions-03-invalid-empty-key_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/dsl_definitions-03-invalid-empty-key.yaml'

# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/handling-unbounded-requirement-count-ranges/types_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/types.yaml'

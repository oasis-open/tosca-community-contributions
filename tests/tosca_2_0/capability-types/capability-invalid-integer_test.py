# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/capability-types/capability-invalid-integer_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/capability-invalid-integer.yaml'

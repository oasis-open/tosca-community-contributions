# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/policy-definitions/policy-defintions-map-inv_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/policy-defintions-map-inv.yaml'

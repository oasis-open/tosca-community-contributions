# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/policy-definitions/policy-defintions-empty-inv_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/policy-defintions-empty-inv.yaml'

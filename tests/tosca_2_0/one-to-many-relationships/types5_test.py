# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/one-to-many-relationships/types_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/one-to-many-relationships-types.yaml'

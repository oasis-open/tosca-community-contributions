# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/artifact-type/artifact_type-06-invalid_description_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/artifact_type-06-invalid_description.yaml'

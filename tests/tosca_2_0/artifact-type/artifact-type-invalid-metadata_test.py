# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/artifact-type/artifact-type-invalid-metadata_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/artifact-type-invalid-metadata.yaml'

# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/group-definitions/group-definitions-list-inv_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/group-definitions-list-inv.yaml'

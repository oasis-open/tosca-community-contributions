# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/metadata/invalid_metadata_missing_value_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/invalid_metadata_missing_value.yaml'

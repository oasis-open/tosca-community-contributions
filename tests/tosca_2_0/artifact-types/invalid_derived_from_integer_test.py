# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/artifact-types/invalid_derived_from_integer_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/invalid_derived_from_integer.yaml'

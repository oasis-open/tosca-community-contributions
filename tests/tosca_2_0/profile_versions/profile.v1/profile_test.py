# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/profile_versions/profile.v1/profile_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/profile.yaml'

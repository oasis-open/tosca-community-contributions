# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/group-types/group-types-invalid-not-string_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/group-types-invalid-not-string.yaml'

# filepath: /home/paul/tosca-community-contributions/tools/scripts/../../tests/tosca_2_0/description/description-04-invalid_non_string_test.py
import subprocess
import unittest
import os
...
tosca_file_path = here + '/description-04-invalid_non_string.yaml'
